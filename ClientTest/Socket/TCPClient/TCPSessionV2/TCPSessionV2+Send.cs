...
public partial class TCPSessionV2
{
    ...
    public void Send(NetworkPackage networkPackage)
    {
        ...
        Buffer.BlockCopy(messageIdBytes, 0, sendBytes, sizeof(int), messageIdBytes.Length);
        Buffer.BlockCopy(networkPackage.Body, 0, sendBytes, NetworkPackage.HeaderSize, networkPackage.BodySize);
    ...
    public void SendAsync(NetworkPackage networkPackage)
    {
        ...
        lock (_sendLock)
        {
            ...
            Buffer.BlockCopy(sizeBytes, 0, _sendBuffer, 0, sizeBytes.Length);
            Buffer.BlockCopy(messageIdBytes, 0, _sendBuffer, sizeof(int), messageIdBytes.Length);
            Buffer.BlockCopy(networkPackage.Body, 0, _sendBuffer, NetworkPackage.HeaderSize, networkPackage.BodySize);
    ...
    {
        var tcpSession = ar.AsyncState as TCPSessionV2;
